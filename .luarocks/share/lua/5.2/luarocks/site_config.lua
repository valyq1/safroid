local site_config = {}
site_config.LUAROCKS_PREFIX=[[/root/DBTeam/.luarocks]]
site_config.LUA_INCDIR=[[/usr/include/lua5.2]]
site_config.LUA_LIBDIR=[[/usr/lib]]
site_config.LUA_BINDIR=[[/usr/bin]]
site_config.LUAROCKS_SYSCONFDIR=[[/root/DBTeam/.luarocks/luarocks]]
site_config.LUAROCKS_ROCKS_TREE=[[/root/DBTeam/.luarocks]]
