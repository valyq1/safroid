...
▫️fwd : قفل فوروارد
▫️contacts : قفل اطلاعات تماس
️▫️strict = ينه قفل باشد ربات سختگير ميشود و کاربر خطا کار را سريع پاک ميکند بدون اخطار
▫️flood = اگر کاربری بصورت رگباری پست ارسال کند حذف میشود میزان آن قابل تغییر است
〰〰〰〰〰
